...
export interface GridpointForecastPeriod {
    ...
    number?: number;
    probabilityOfPrecipitation?: WeatherGov.QuantitativeValue;
     ...
     */
    temperature?: WeatherGov.GridpointForecastPeriodTemperature;
    ...
    temperatureTrend?: WeatherGov.GridpointForecastPeriodTemperatureTrend;
    /**
     ...
     */
    temperatureUnit?: WeatherGov.GridpointForecastPeriodTemperatureUnit;
    /** The prevailing direction of the wind for the period, using a 16-point compass. */
    windDirection?: WeatherGov.GridpointForecastPeriodWindDirection;
    /**
     ...
     */
    windGust?: WeatherGov.GridpointForecastPeriodWindGust;
    /**
     * Wind speed for the period.
     * This property as an string value is deprecated. Future versions will express this value as a quantitative value object. To make use of the future standard format now, set the "forecast_wind_speed_qv" feature flag on the request.
     */
    windSpeed?: WeatherGov.GridpointForecastPeriodWindSpeed;
}
